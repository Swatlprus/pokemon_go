# Generated by Django 3.1.14 on 2022-12-11 15:25
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title_en', models.CharField(blank=True, max_length=200, verbose_name='Имя покемона на англ.яз')),
                ('title_jp', models.CharField(blank=True, max_length=200, verbose_name='Имя покемона на япон.яз')),
                ('photo', models.ImageField(blank=True, null=True, upload_to='pokemons', verbose_name='Изображение')),
                ('description', models.TextField(blank=True, verbose_name='Описание')),
                ('previous_evolution', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='previous_evolutions', to='pokemon_entities.pokemon', verbose_name='Эволюционировал из')),
            ],
        ),
        migrations.CreateModel(
            name='PokemonEntity',
